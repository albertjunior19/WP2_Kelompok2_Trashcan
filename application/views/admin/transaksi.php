                ...
                <td>
                  ...
                  <td>
                    <?php if ($pro['transaksi_status'] != 'Belum Mengupload Bukti Pembayaran') { ?>
                      <center><img width="200px" src="<?php echo base_url('assets_home/img/buktipembayaran/' . $pro['buktipembayaran']) ?>" alt=""><br><br> <a class="btn btn-primary" target="_blank" href="<?php echo base_url('assets_home/img/buktipembayaran/' . $pro['buktipembayaran']) ?>">Lihat</a></center>
                    <?php } ?>
                  </td>
                  <td>
                    <a href="<?php echo base_url(); ?>admin/detail_transaksi/<?php echo $pro['transaksi_id']; ?>" title="" class="btn-st drk-blu-clr"><?= $tulisan ?></a>
                  </td>
                  <td>
                    <a href="<?php echo base_url(); ?>admin/detail_transaksi/<?php echo $pro['transaksi_id']; ?>" title="Detail Transaksi" class="btn-st blu-clr"><i class="fa fa-eye"></i></a>
                  </td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
